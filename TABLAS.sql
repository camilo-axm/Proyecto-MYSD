...
CREATE TABLE Planificacion (
    idPlanificacion NUMBER NOT NULL,
    titulo VARCHAR2(100) NOT NULL,
    descripcion VARCHAR2(300) NOT NULL,
    objetivo VARCHAR2(300) NOT NULL,
...
CREATE TABLE EstadoCuenta (
    idEstadoCuenta NUMBER NOT NULL,
    fechaGeneracion DATE NOT NULL,
    totalPagado NUMBER(10,2) NOT NULL,
    totalPendiente NUMBER(10,2) NOT NULL,
    idInscripcion NUMBER NOT NULL
);

CREATE TABLE Convocatoria (
    idConvocatoria NUMBER NOT NULL,
    fechaEvento DATE NOT NULL,
    lugarEvento VARCHAR2(100) NOT NULL,
    tipoEvento VARCHAR2(50) NOT NULL,
    descripcion VARCHAR2(300) NULL,
    estadoEvento varchar2(30) NOT NULL,
    idPersona NUMBER NOT NULL,
    idEquipo NUMBER NOT NULL
);